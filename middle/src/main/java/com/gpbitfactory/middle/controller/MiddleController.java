...
public class MiddleController {
    ...
    @Autowired
    public MiddleController(@Qualifier("middleUserService") UserService userService,
                            @Qualifier("middleAccountService") AccountService accountService,
                            @Qualifier("middleTransferService") TransferService transferService) {
